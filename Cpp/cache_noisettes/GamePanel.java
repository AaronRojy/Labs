...
public class GamePanel extends JPanel implements ActionListener, KeyListener, MouseListener {
    ...
    public void startGame() {
        //USED for a game time at the end
        running = true;
    ...
    public void draw(Graphics g) { 
        ...
        //iterates throught all the valuses in 2d array and sets them to the correct image 
        if (running==true) {
            //draws a grid, of 6x6 but ca be chaged if  UNIT_SIZE, SCREEN_HEIGHT, SCREEN_WIDTH chage which is by design, was going to make the levels get bigger and bigger but wasnt in breif
            ...
            // total nut is zero when all utsare in holes or there is an error in the game setup, either way the next level should be implimted
            if (totalNut ==0){
    ...
    public void newNut() {
        ...
        //unsued method as it could cause unbeatable levels
    }
    ...
    public void levelEightSetup() {
        ...
        tempSquirrelX = squirrelX;
        tempSquirrelY = squirrelY;
    ...
    //sets X and Y veriable into 2d array 
    ...
    public void move(int direction) {
        ...
        for (int i = chain_length; i >= 0; i--) {
            ...
            if (movingVal == 4) movingVal = 2; // squirrel in hole into squirrel
            else if (movingVal == 5) movingVal = 1; // nut in hole into nut
    ...
    public void keyPressed(KeyEvent e) {
        ...
        if (key == KeyEvent.VK_W || key == KeyEvent.VK_UP) {
            ...
            int locatTempSquirrelX = tempSquirrelX;
            int locatTempSquirrelY= tempSquirrelY;
            
            squirrelX = tempSquirrelX;
            squirrelY = tempSquirrelY;
            
            tempSquirrelX = locatTempSquirrelX;
            tempSquirrelY = locatTempSquirrelY;
